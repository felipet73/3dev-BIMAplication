...
const CarouselPubs = () => {
        ...
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="120%" height="100%" src={require(`../assets/images/${'6'}.png`)} alt="San Francisco" />
                    </picture>
                </div>
            </div>
        );
    ...
    const itemTemplate2 = () => {
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="120%" height="100%" src={require(`../assets/images/${'6'}.png`)} alt="London" />
                    </picture>
                </div>
            </div>
        );
    ...
    const itemTemplate3 = () => {
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="120%" height="100%" src={require(`../assets/images/${'6'}.png`)} alt="Tokyo" />
                    </picture>
                </div>
            </div>
        );
    ...
    const itemTemplate4 = () => {
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="120%" height="100%" src={require(`../assets/images/${'6'}.png`)} alt="Moscow" />
                    </picture>
                </div>
            </div>
        );
    ...
    return (
        <div className='control-pane' style={{marginTop:'150px', marginBottom:'150px'}}>
            ...
            <img src={require(`../assets/images/${'tt4'}.png`)} alt="iPhone X" height="100%" style={{ width: '40%', marginLeft:'30vw' }} />
