...
class Dashboard {
    ...
    adjustLayout() {
        ...
        //$(row[1]).removeClass('col-sm-8').addClass('col-sm-5 transition-width').after('<div class="col-sm-3 transition-width" id="dashboard"></div>');
        $(row).addClass("card fill").after('<div class="transition-width" id="dashboard"></div>');
